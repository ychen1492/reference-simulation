...
def run_simulation():
    ...
    if not os.path.exists('SerialLayersHe'):
        os.mkdir('SerialLayersHe')
    ...
    if not os.path.exists('SerialLayersHe'):
        os.mkdir('SerialLayersHe')
    output_path = os.path.relpath(f'SerialLayersHe/temperature_layers.csv')
    output_path_pressure = os.path.relpath(f'SerialLayersHe/pressure_layers.csv')
